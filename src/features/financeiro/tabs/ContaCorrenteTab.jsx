 ...
 * Corrigido com caminhos de importação A4 relativos estritos (../../../) [2].
 */
...
import { db } from '../../../firebase'; // ◄ CORRIGIDO: Caminho relativo correto para o firebase.js [2]
import { collection, doc, writeBatch, query, where, onSnapshot } from 'firebase/firestore';
import { suspenderParcelaCaucao, obterDadosExtratoEntidade } from '../../../services/financeiroService'; // ◄ CORRIGIDO: Caminho correto [2]
import { logAcaoGlobal } from '../../../utils/logger';

// ◄ CORRIGIDO: Caminho de importação relativo correto para o Button (3 níveis acima) [2]
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        {/* Cabeçalho com o botão "Realizar Fecho & Extrato" de sementeira individual */}
